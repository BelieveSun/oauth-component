...
public class HttpMethodPermissionFilter extends PermissionsAuthorizationFilter {
     ...
     */
    private static final Logger log = LoggerFactory.getLogger(org.apache.shiro.web.filter.authz.HttpMethodPermissionFilter.class);
     ...
     * {@link org.apache.shiro.web.filter.authz.PermissionsAuthorizationFilter#isAccessAllowed(javax.servlet.ServletRequest, javax.servlet.ServletResponse, Object) isAccessAllowed}
